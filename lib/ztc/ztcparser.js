...
/**
 * Method used to read a moment in time.
 *
 * @param {!String} name - The name of the field
 * @returns {ZtcParser} - This instance.
 */
ZtcParser.prototype.moment = function (name) {
    return this.uint32le(name).tap(function () {
        this.vars[name] = moment().year(2000).startOf("year").add("s", this.vars[name]);
    });
};

/**
 * Method used to read a boolean value.
 *
 * @param {!String} name - The name of the field.
 * @returns {ZtcParser} - This instance.
 */
ZtcParser.prototype.boolean = function (name) {
    return this.uint8(name).tap(function () {
