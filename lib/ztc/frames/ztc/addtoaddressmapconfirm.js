...
/**
 * Create a new AddToAddressMapConfirm instance.
 *
 * @param {!ZtcParser} parser - The parser to read the message from.
 * @constructor
 */
function AddToAddressMapConfirm(parser) {
    ZtcFrame.call(this);
    var _self = this;
...
util.inherits(AddToAddressMapConfirm, ZtcFrame);
 ...
 * @type {number}
 */
AddToAddressMapConfirm.OPCODE_GROUP = 0xA4;
 ...
 * @type {number}
 */
AddToAddressMapConfirm.OPCODE = 0xC0;
